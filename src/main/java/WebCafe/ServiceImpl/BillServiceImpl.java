...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if(validateRequestMap(requestMap)){
                ...
                Paragraph chunk = new Paragraph("WEB CAFE - Bill",getFont("Header"));
                ...
                JSONArray jsonArray = CafeUltils.getJsonArrayFromString((String) requestMap.get("productDetails"));
                for (int i = 0; i<jsonArray.length(); i++){
                    addRows(table,CafeUltils.getMapFromData(jsonArray.getString(i)));
                }
                document.add(table);
            ...
            return CafeUltils.getResponseEntity("Required data not found!",HttpStatus.BAD_REQUEST);
        }catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try{
            ...
            if (CafeUltils.isFileExist(filePath)){
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if(!optional.isEmpty()){
                ...
                return CafeUltils.getResponseEntity("Bill deleted!",HttpStatus.OK);
            }
            return CafeUltils.getResponseEntity("Bill id does not exist!",HttpStatus.BAD_REQUEST);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return CafeUltils.getResponseEntity(CafeConstants.SOMETHING_WENT_WRONG,HttpStatus.INTERNAL_SERVER_ERROR);
