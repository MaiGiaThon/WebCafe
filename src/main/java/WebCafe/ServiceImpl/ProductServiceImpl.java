        ...
        try{
            if(jwtFilter.isAdmin()){
                ...
                if(!optional.isEmpty()){
                    ...
                    return CafeUltils.getResponseEntity("Product deleted!",HttpStatus.OK);
                }
                return CafeUltils.getResponseEntity("Product id does exist!",HttpStatus.OK);
            }else {
                return CafeUltils.getResponseEntity(CafeConstants.UNAUTHORIZED_ACCESS,HttpStatus.UNAUTHORIZED);
            }
        }catch (Exception ex){
        ...
        try{
            if(jwtFilter.isAdmin()){
                ...
                if(!optional.isEmpty()){
                    ...
                    return CafeUltils.getResponseEntity("Product status updated!",HttpStatus.OK);
                }
                return CafeUltils.getResponseEntity("Product id does exist!",HttpStatus.OK);
            }else {
                return CafeUltils.getResponseEntity(CafeConstants.UNAUTHORIZED_ACCESS,HttpStatus.UNAUTHORIZED);
